...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260308123648_SqlServerMigration'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425090414_AddCustomerFields'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425091829_AddRubrosSubrubros'
)
BEGIN
    DECLARE @var sysname;
    SELECT @var = [d].[name]
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425092310_AddScaleFields'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425092604_AddProductImage'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425093211_AddStockManagement'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425093703_ChangeStockToDecimal'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425094325_AddVatConditions'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425095310_SplitTaxEntities'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425100021_AddPurchaseImageAndLetter'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425101623_AddProductPricingFields'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425102454_AddProductPriceHistory'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425110109_AddSystemSettings'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260501094828_AddCuitAndTaxConditionToCustomer'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260501095813_AddMinimumStockAndPurchaseStatus'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260515091427_AddExpirationDaysToProduct'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260515091742_FixSaleItemQuantityType'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260516101836_AddPointsOfSale'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260516102919_AddMachineNameToPOS'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260516104448_AddPosNumberToPOS'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260518223043_AddElectronicInvoicing'
)
BEGIN
...
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_ElectronicInvoices_SaleId] ON [ElectronicInvoices] ([SaleId]) WHERE [SaleId] IS NOT NULL');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260520084603_AddFiscalPrintSpooler'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260524102013_AddCashRegisterMovements'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260610021043_AddLastSentToScaleDate'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260613100854_AddMercadoPagoConfig'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260613102852_SeedMercadoPagoMethod'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260614011503_AddTransactionReferenceToPayments'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260614020100_AddSaleCancellationFields'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260615100426_AddDiscountAndPromotionSystem'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260615104737_AddStackablePromotionsAndPaymentDiscounts'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260616020222_AddMercadoPagoOAuthFields'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260619021826_AddDepartmentsAndCustomSaleItemName'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260621020239_AddNeedsLabelPrint'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260624024200_AddIsFractionableToProduct'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260626082413_AddPrinterNameToPos'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260626090146_AddPrintCopiesToPointOfSale'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260703021041_AddSupplierCode'
)
BEGIN
