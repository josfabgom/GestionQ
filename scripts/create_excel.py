...
out_dir = r"d:\Antigravity Proyectos\GestionQ\out"
out_path = os.path.join(out_dir, "productos_a_importar.xlsx")
df.to_excel(out_path, index=False)

print(f"Generated Excel with {len(products)} products at {out_path}")
